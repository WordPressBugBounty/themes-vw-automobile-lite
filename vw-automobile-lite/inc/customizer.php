...
function vw_automobile_lite_customize_register($wp_customize) {
    ...
    $wp_customize->add_section( 'vw_automobile_lite_slidersettings' , array(
      ...
      'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.themescaliber.com/products/automobile-wordpress-theme">GET PRO</a>','vw-automobile-lite'),
      'priority'   => null,
      'panel' => 'vw_automobile_lite_homepage_panel'
    ));
	...
	$wp_customize->add_setting('vw_automobile_lite_top_button_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('vw_automobile_lite_top_button_url',array(
		'label'	=> __('Add Button URL','vw-automobile-lite'),
		'section'	=> 'vw_automobile_lite_slidersettings',
		'setting'	=> 'vw_automobile_lite_top_button_url',
		'type'	=> 'url',
		'active_callback' => 'vw_automobile_lite_default_slider'
	));
	...
	$wp_customize->add_section('vw_automobile_lite_choose_us', array(
		...
		'description' => __('For more options of the Choose us section <a class="go-pro-btn" target="blank" href="https://www.themescaliber.com/products/automobile-wordpress-theme">GET PRO</a>','vw-automobile-lite'),
		'priority'    => null,
		'panel'       => 'vw_automobile_lite_homepage_panel',
	));
	...
	$wp_customize->add_section('vw_automobile_lite_footer', array(
		...
		'description' => __('For more options of the footer section <a class="go-pro-btn" target="blank" href="https://www.themescaliber.com/products/automobile-wordpress-theme">GET PRO</a>','vw-automobile-lite'),
		'priority'    => null,
		'panel'       => 'vw_automobile_lite_homepage_panel',
	));
    ...
    $wp_customize->add_control( new vw_automobile_lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_automobile_lite_footer_hide_show',array(
 	...
 	// font size
	$wp_customize->add_setting('vw_automobile_lite_button_footer_font_size',array(
		'default'=> 18,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_automobile_lite_button_footer_font_size',array(
		'label'	=> __('Footer Heading Font Size','vw-automobile-lite'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	$wp_customize->add_setting('vw_automobile_lite_button_footer_heading_letter_spacing',array(
		'default'=> 1,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_automobile_lite_button_footer_heading_letter_spacing',array(
		'label'	=> __('Heading Letter Spacing','vw-automobile-lite'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	// text trasform
	$wp_customize->add_setting('vw_automobile_lite_button_footer_text_transform',array(
		'default'=> 'Uppercase',
		'sanitize_callback'	=> 'vw_automobile_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_automobile_lite_button_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','vw-automobile-lite'),
		'choices' => array(
      'Uppercase' => __('Uppercase','vw-automobile-lite'),
      'Capitalize' => __('Capitalize','vw-automobile-lite'),
      'Lowercase' => __('Lowercase','vw-automobile-lite'),
	...
	$wp_customize->add_setting('vw_automobile_lite_footer_heading_weight',array(
        'default' => 600,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_automobile_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_automobile_lite_footer_heading_weight',array(
        'type' => 'select',
        'label' => __('Heading Font Weight','vw-automobile-lite'),
        'section' => 'vw_automobile_lite_footer',
        'choices' => array(
        	'100' => __('100','vw-automobile-lite'),
            '200' => __('200','vw-automobile-lite'),
  	...
  	$wp_customize->add_setting('vw_automobile_lite_footer_template',array(
	    'default'	=> esc_html('vw-automobile-lite-footer-one'),
	    'sanitize_callback'	=> 'vw_automobile_lite_sanitize_choices'
  	));
 	$wp_customize->add_control('vw_automobile_lite_footer_template',array(
        'label'	=> esc_html__('Footer style','vw-automobile-lite'),
        'section'	=> 'vw_automobile_lite_footer',
        'setting'	=> 'vw_automobile_lite_footer_template',
        'type' => 'select',
        'choices' => array(
            'vw-automobile-lite-footer-one' => esc_html__('Style 1', 'vw-automobile-lite'),
            'vw-automobile-lite-footer-two' => esc_html__('Style 2', 'vw-automobile-lite'),
            'vw-automobile-lite-footer-three' => esc_html__('Style 3', 'vw-automobile-lite'),
            'vw-automobile-lite-footer-four' => esc_html__('Style 4', 'vw-automobile-lite'),
            'vw-automobile-lite-footer-five' => esc_html__('Style 5', 'vw-automobile-lite'),
        )
  	));
	...
	$wp_customize->add_setting( 'vw_automobile_lite_related_toggle_postdate',array(
	    'default' => 1,
	    'transport' => 'refresh',
	    'sanitize_callback' => 'vw_automobile_lite_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Automobile_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_automobile_lite_related_toggle_postdate',array(
	    'label' => esc_html__( 'Show / Hide Post Date','vw-automobile-lite' ),
	    'section' => 'vw_automobile_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_automobile_lite_related_postdate_icon',array(
	    'default' => 'fas fa-calendar-alt',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Automobile_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_automobile_lite_related_postdate_icon',array(
	    'label' => __('Add Post Date Icon','vw-automobile-lite'),
	    'transport' => 'refresh',
	    'section' => 'vw_automobile_lite_related_posts_settings',
	    'setting' => 'vw_automobile_lite_related_postdate_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_automobile_lite_related_toggle_author',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_automobile_lite_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Automobile_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_automobile_lite_related_toggle_author',array(
		'label' => esc_html__( 'Show / Hide Author','vw-automobile-lite' ),
		'section' => 'vw_automobile_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_automobile_lite_related_author_icon',array(
	    'default' => 'fas fa-user',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Automobile_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_automobile_lite_related_author_icon',array(
	    'label' => __('Add Author Icon','vw-automobile-lite'),
	    'transport' => 'refresh',
	    'section' => 'vw_automobile_lite_related_posts_settings',
	    'setting' => 'vw_automobile_lite_related_author_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_automobile_lite_related_toggle_comments',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_automobile_lite_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Automobile_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_automobile_lite_related_toggle_comments',array(
		'label' => esc_html__( 'Show / Hide Comments','vw-automobile-lite' ),
		'section' => 'vw_automobile_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_automobile_lite_related_comments_icon',array(
	    'default' => 'fa fa-comments',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Automobile_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_automobile_lite_related_comments_icon',array(
	    'label' => __('Add Comments Icon','vw-automobile-lite'),
	    'transport' => 'refresh',
	    'section' => 'vw_automobile_lite_related_posts_settings',
	    'setting' => 'vw_automobile_lite_related_comments_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_automobile_lite_related_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_automobile_lite_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Automobile_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_automobile_lite_related_toggle_time',array(
		'label' => esc_html__( 'Show / Hide Time','vw-automobile-lite' ),
		'section' => 'vw_automobile_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_automobile_lite_related_time_icon',array(
	    'default' => 'fas fa-clock',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Automobile_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_automobile_lite_related_time_icon',array(
	    'label' => __('Add Time Icon','vw-automobile-lite'),
	    'transport' => 'refresh',
	    'section' => 'vw_automobile_lite_related_posts_settings',
	    'setting' => 'vw_automobile_lite_related_time_icon',
	    'type'    => 'icon'
  	)));
	...
	$wp_customize->add_setting( 'vw_automobile_lite_related_image_hide_show',array(
  	...
  	$wp_customize->add_control( new VW_Automobile_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_automobile_lite_related_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-automobile-lite' ),
		'section' => 'vw_automobile_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting( 'vw_automobile_lite_related_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_automobile_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_automobile_lite_related_image_box_shadow', array(
		'label'       => esc_html__( 'Related post Image Box Shadow','vw-automobile-lite' ),
		'section'     => 'vw_automobile_lite_related_posts_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
  	...
  	$wp_customize->add_setting('vw_automobile_lite_related_button_text',array(
		'default'=> esc_html__('Read More','vw-automobile-lite'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_automobile_lite_related_button_text',array(
	...
	$wp_customize->add_setting('vw_automobile_lite_grid_excerpt_settings',array(
        'default' => 'Excerpt',
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_automobile_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_automobile_lite_grid_excerpt_settings',array(
        'type' => 'select',
        'label' => esc_html__('Grid Post Content','vw-automobile-lite'),
        'section' => 'vw_automobile_lite_grid_layout_settings',
        'choices' => array(
        	'Content' => esc_html__('Content','vw-automobile-lite'),
            'Excerpt' => esc_html__('Excerpt','vw-automobile-lite'),
            'No Content' => esc_html__('No Content','vw-automobile-lite')
        ),
	) );
	...
	$wp_customize->add_setting('vw_automobile_lite_bradcrumbs_alignment',array(
        'default' => 'Left',
        'sanitize_callback' => 'vw_automobile_lite_sanitize_choices'
	));
	$wp_customize->add_control('vw_automobile_lite_bradcrumbs_alignment',array(
        'type' => 'select',
        'label' => __('Bradcrumbs Alignment','vw-automobile-lite'),
        'section' => 'vw_automobile_lite_left_right',
        'choices' => array(
            'Left' => __('Left','vw-automobile-lite'),
            'Right' => __('Right','vw-automobile-lite'),
	...
	$wp_customize->add_setting( 'vw_automobile_lite_responsive_preloader_hide',array(
        'default' => false,
        'transport' => 'refresh',
        'sanitize_callback' => 'vw_automobile_lite_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Automobile_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'vw_automobile_lite_responsive_preloader_hide',array(
        'label' => esc_html__( 'Show / Hide Preloader','vw-automobile-lite' ),
...
final class VW_Automobile_Lite_Customize {
	...
	public function sections($manager) {
		...
		$manager->add_section(new VW_Automobile_Lite_Customize_Section_Pro($manager,'vw_automobile_lite_upgrade_pro_link',array(
			...
			'pro_url'  => esc_url('https://www.themescaliber.com/products/automobile-wordpress-theme')
		)));
		...
		$manager->add_section(new VW_Automobile_Lite_Customize_Section_Pro($manager,'vw_automobile_lite_get_started_link',array(
			...
			'pro_url'  => esc_url('https://preview.themescaliber.com/doc/free-automobile/')
		)));

		$manager->add_section(new VW_Automobile_Lite_Customize_Section_Pro($manager,'vw_automobile_lite_get_bundle_link',array(
			'priority'   => 1,
			'title'    => esc_html__( 'Get 250+ Themes Bundle at $99', 'vw-automobile-lite' ),
			'pro_text' => esc_html__( 'Get Bundle', 'vw-automobile-lite' ),
