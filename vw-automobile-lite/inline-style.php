<?php
 ...
 .wc-block-components-checkout-place-order-button, .wc-block-components-totals-coupon__button{';
	...
	if($vw_automobile_lite_first_color != false){
		$vw_automobile_lite_custom_css .='.search-submit, .blogbutton-small,a.wp-block-button__link.add_to_cart_button.ajax_add_to_cart, .woocommerce-cart .wc-block-grid .wc-block-grid__product-onsale{';
    ...
    if($vw_automobile_lite_theme_lay == 'Left'){
		...
		$vw_automobile_lite_custom_css .='.slider .carousel-caption, .slider .inner_carousel, .slider .inner_carousel h1{';
			$vw_automobile_lite_custom_css .='text-align:center; left:30%; right:30%;';
		$vw_automobile_lite_custom_css .='}';
	...
	$vw_automobile_lite_resp_slider = get_theme_mod( 'vw_automobile_lite_resp_slider_hide_show',true);
	if($vw_automobile_lite_resp_slider == true && get_theme_mod( 'vw_automobile_lite_slider_hide_show', true) == false){
    	$vw_automobile_lite_custom_css .='.slider{';
	...
	if($vw_automobile_lite_resp_menu_toggle_btn_bg_color != false){
		$vw_automobile_lite_custom_css .='.toggle-nav button,.sidenav .closebtn{';
	...
	$vw_automobile_lite_button_letter_spacing = get_theme_mod('vw_automobile_lite_button_letter_spacing');
	$vw_automobile_lite_custom_css .='.blogbutton-small {';
	...
	if($vw_automobile_lite_featured_image_box_shadow != false){
		$vw_automobile_lite_custom_css .='.post-main-box img, #content-vw img{';
	...
	$vw_automobile_lite_singlepost_image_box_shadow = get_theme_mod('vw_automobile_lite_singlepost_image_box_shadow',0);
	if($vw_automobile_lite_singlepost_image_box_shadow != false){
		$vw_automobile_lite_custom_css .='.feature-box img{';
			$vw_automobile_lite_custom_css .='box-shadow: '.esc_attr($vw_automobile_lite_singlepost_image_box_shadow).'px '.esc_attr($vw_automobile_lite_singlepost_image_box_shadow).'px '.esc_attr($vw_automobile_lite_singlepost_image_box_shadow).'px #cccccc;';
		$vw_automobile_lite_custom_css .='}';
	}

	$vw_automobile_lite_related_image_box_shadow = get_theme_mod('vw_automobile_lite_related_image_box_shadow',0);
	if($vw_automobile_lite_related_image_box_shadow != false){
		$vw_automobile_lite_custom_css .='.related-post .box-image img{';
			$vw_automobile_lite_custom_css .='box-shadow: '.esc_attr($vw_automobile_lite_related_image_box_shadow).'px '.esc_attr($vw_automobile_lite_related_image_box_shadow).'px '.esc_attr($vw_automobile_lite_related_image_box_shadow).'px #cccccc;';
		$vw_automobile_lite_custom_css .='}';
	}
	...
	$vw_automobile_lite_align_footer_social_icon = get_theme_mod('vw_automobile_lite_align_footer_social_icon');
	if($vw_automobile_lite_align_footer_social_icon != false){
		$vw_automobile_lite_custom_css .='.copyright .widget{';
			$vw_automobile_lite_custom_css .='text-align: '.esc_attr($vw_automobile_lite_align_footer_social_icon).';';
		$vw_automobile_lite_custom_css .='}';
		$vw_automobile_lite_custom_css .='
		@media screen and (max-width:720px) {
			.copyright .widget{';
	...
	if($vw_automobile_lite_footer_background_image != false){
		$vw_automobile_lite_custom_css .='.footer{';
			$vw_automobile_lite_custom_css .='background: url('.esc_attr($vw_automobile_lite_footer_background_image).'); background-size: cover;';
		$vw_automobile_lite_custom_css .='}';
	}
	...
	$vw_automobile_lite_custom_css .='.footer h3, .footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
		$vw_automobile_lite_custom_css .='letter-spacing: '.esc_attr($vw_automobile_lite_button_footer_heading_letter_spacing).'px;';
	$vw_automobile_lite_custom_css .='}';

	$vw_automobile_lite_button_footer_font_size = get_theme_mod('vw_automobile_lite_button_footer_font_size','18');
	$vw_automobile_lite_custom_css .='.footer h3, .footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
		$vw_automobile_lite_custom_css .='font-size: '.esc_attr($vw_automobile_lite_button_footer_font_size).'px;';
	$vw_automobile_lite_custom_css .='}';

	$vw_automobile_lite_theme_lay = get_theme_mod( 'vw_automobile_lite_button_footer_text_transform','Uppercase');
	if($vw_automobile_lite_theme_lay == 'Capitalize'){
		$vw_automobile_lite_custom_css .='.footer h3, .footer .wp-block-search .wp-block-search__label{';
			$vw_automobile_lite_custom_css .='text-transform:Capitalize;';
		$vw_automobile_lite_custom_css .='}';
	...
	$vw_automobile_lite_footer_heading_weight = get_theme_mod('vw_automobile_lite_footer_heading_weight','600');
	if($vw_automobile_lite_footer_heading_weight != false){
		$vw_automobile_lite_custom_css .='.footer h3, .footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
			$vw_automobile_lite_custom_css .='font-weight: '.esc_attr($vw_automobile_lite_footer_heading_weight).';';
		$vw_automobile_lite_custom_css .='}';
	}

	/*---------------------------Footer Style -------------------*/

	$vw_automobile_lite_theme_lay = get_theme_mod( 'vw_automobile_lite_footer_template','vw-automobile-lite-footer-one');
    if($vw_automobile_lite_theme_lay == 'vw-automobile-lite-footer-one'){
		$vw_automobile_lite_custom_css .='.footer{';
			$vw_automobile_lite_custom_css .='';
		$vw_automobile_lite_custom_css .='}';

	}else if($vw_automobile_lite_theme_lay == 'vw-automobile-lite-footer-two'){
		$vw_automobile_lite_custom_css .='.footer{';
			$vw_automobile_lite_custom_css .='background: linear-gradient(to right, #f9f8ff, #dedafa);';
		$vw_automobile_lite_custom_css .='}';
		$vw_automobile_lite_custom_css .='.footer p, .footer li a, .footer, .footer h3, .footer a.rsswidget, .footer #wp-calendar a, .copyright a, .footer .custom_details, .footer ins span, .footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, .footer ul li a, .footer table, .footer th, .footer td, .footer caption, #sidebar caption,.footer nav.wp-calendar-nav a,.footer .search-form .search-field{';
			$vw_automobile_lite_custom_css .='color:#000;';
		$vw_automobile_lite_custom_css .='}';
		$vw_automobile_lite_custom_css .='.footer ul li::before{';
			$vw_automobile_lite_custom_css .='background:#000;';
		$vw_automobile_lite_custom_css .='}';
		$vw_automobile_lite_custom_css .='.footer table, .footer th, .footer td,.footer .search-form .search-field,.footer .tagcloud a{';
			$vw_automobile_lite_custom_css .='border: 1px solid #000;';
		$vw_automobile_lite_custom_css .='}';

	}else if($vw_automobile_lite_theme_lay == 'vw-automobile-lite-footer-three'){
		$vw_automobile_lite_custom_css .='.footer{';
			$vw_automobile_lite_custom_css .='background: #232524;';
		$vw_automobile_lite_custom_css .='}';
	}
	else if($vw_automobile_lite_theme_lay == 'vw-automobile-lite-footer-four'){
		$vw_automobile_lite_custom_css .='.footer{';
			$vw_automobile_lite_custom_css .='background: #f7f7f7;';
		$vw_automobile_lite_custom_css .='}';
		$vw_automobile_lite_custom_css .='.footer p, .footer li a, .footer, .footer h3, .footer a.rsswidget, .footer #wp-calendar a, .copyright a, .footer .custom_details, .footer ins span, .footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, .footer ul li a, .footer table, .footer th, .footer td, .footer caption, #sidebar caption,.footer nav.wp-calendar-nav a,.footer .search-form .search-field{';
			$vw_automobile_lite_custom_css .='color:#000;';
		$vw_automobile_lite_custom_css .='}';
	...
	else if($vw_automobile_lite_theme_lay == 'vw-automobile-lite-footer-five'){
		$vw_automobile_lite_custom_css .='.footer{';
			$vw_automobile_lite_custom_css .='background: linear-gradient(to right, #01093a, #2d0b00);';
		$vw_automobile_lite_custom_css .='}';
	}

	$vw_automobile_lite_responsive_preloader_hide = get_theme_mod('vw_automobile_lite_responsive_preloader_hide',false);
	if($vw_automobile_lite_responsive_preloader_hide == true && get_theme_mod('vw_automobile_lite_loader_enable',false) == false){
		$vw_automobile_lite_custom_css .='@media screen and (min-width:575px){
			#preloader{';
			$vw_automobile_lite_custom_css .='display:none !important;';
		$vw_automobile_lite_custom_css .='} }';
	}

	if($vw_automobile_lite_responsive_preloader_hide == false){
		$vw_automobile_lite_custom_css .='@media screen and (max-width:575px){
			#preloader{';
			$vw_automobile_lite_custom_css .='display:none !important;';
		$vw_automobile_lite_custom_css .='} }';
	...
	$vw_automobile_lite_bradcrumbs_alignment = get_theme_mod( 'vw_automobile_lite_bradcrumbs_alignment','Left');
    if($vw_automobile_lite_bradcrumbs_alignment == 'Left'){
    	$vw_automobile_lite_custom_css .='@media screen and (min-width:768px) {';
		$vw_automobile_lite_custom_css .='.bradcrumbs{';
			$vw_automobile_lite_custom_css .='text-align:start;';
		$vw_automobile_lite_custom_css .='}}';
	}else if($vw_automobile_lite_bradcrumbs_alignment == 'Center'){
		$vw_automobile_lite_custom_css .='@media screen and (min-width:768px) {';
		$vw_automobile_lite_custom_css .='.bradcrumbs{';
			$vw_automobile_lite_custom_css .='text-align:center;';
		$vw_automobile_lite_custom_css .='}}';
	}else if($vw_automobile_lite_bradcrumbs_alignment == 'Right'){
		$vw_automobile_lite_custom_css .='@media screen and (min-width:768px) {';
		$vw_automobile_lite_custom_css .='.bradcrumbs{';
			$vw_automobile_lite_custom_css .='text-align:end;';
		$vw_automobile_lite_custom_css .='}}';
	}